...
static const unsigned char smartgap = 0;        /* only if more than 1 window in the tag */
...
static const Layout layouts[] = {
	...
	{ "[M]",      monocle },
	{ "|||",      threecolumn },
	{ NULL,       NULL },    /* NULL symbol marks end for cyclelayout */
};
...
static const char *dispcfgcmd[]  = { "arandr", NULL };
static const char *filescmd[]  = { "thunar", NULL };
static const char *emailcmd[]  = { "", NULL };
static const char *calendarcmd[]  = { "", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_p,      spawn,          {.v = dispcfgcmd } },
	...
	{ MODKEY,                       XK_y,      togglelayout,   {.v = &layouts[1]} },
	{ MODKEY,                       XK_m,      togglelayout,   {.v = &layouts[2]} },
	{ MODKEY,                       XK_backslash, cyclelayout, {.ui = 3} },
